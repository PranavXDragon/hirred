...
const WhyJoinUsShowcase = ({ company }) => {
  // Use mock perks based on company or default to tech perks
  const perks = company.perks || [
    { icon: <Rocket size={24} />, title: 'Hyper-Growth', desc: 'Join a scaling team working on high-impact products.' },
    { icon: <ShieldCheck size={24} />, title: 'Elite Benefits', desc: 'Top-tier health, dental, and wellness stipends.' },
    { icon: <Coffee size={24} />, title: 'Flexible Culture', desc: 'Remote-first or hybrid. You choose where you do your best work.' },
    { icon: <Code size={24} />, title: 'Modern Stack', desc: 'Work with Next.js, Rust, Go, and the latest AI models.' },
    { icon: <Zap size={24} />, title: 'Fast Execution', desc: 'Zero red tape. Ship code to production on day one.' },
    { icon: <HeartHandshake size={24} />, title: 'Equity Grants', desc: 'Own a piece of the architecture you build.' },
  ];
